def call() {
  ...
  emailext (body: '''${SCRIPT, template="groovy-html-1.template"}''', mimeType: 'text/html', subject: "${currentBuild.currentResult}: Build ${env.JOB_NAME} - ${env.BUILD_NUMBER}", attachLog: false, recipientProviders: [requestor()], to: "manas.vyas29@gmail.com")
